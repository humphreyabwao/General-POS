    ...
    tr.innerHTML = `
        ...
        <td>
            <div class="action-menu">
                <button class="action-menu-btn" data-customer-id="${customer.id}" title="More actions">⋮</button>
                <div class="action-menu-dropdown" data-customer-id="${customer.id}">
                    <button class="action-menu-item view-btn" data-customer-id="${customer.id}">
                        <span>👁️</span> View
                    </button>
                    <button class="action-menu-item edit-btn" data-customer-id="${customer.id}">
                        <span>✏️</span> Edit
                    </button>
                    <button class="action-menu-item delete" data-customer-id="${customer.id}">
                        <span>🗑️</span> Delete
                    </button>
                </div>
            </div>
